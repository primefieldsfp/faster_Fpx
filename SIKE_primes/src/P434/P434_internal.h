...
void fp2sqr434_mont_old(const f2elm_t a, f2elm_t c);     /////////////////// TEMPORARY
void fp2sqr434_c0_mont(const digit_t* a, digit_t* c);     /////////////////// TEMPORARY
void fp2sqr434_c0_asm(const digit_t* a, digit_t* c);        /////////////////// TEMPORARY
void fp2sqr434_c1_mont(const digit_t* a, digit_t* c);     /////////////////// TEMPORARY
void fp2sqr434_c1_asm(const digit_t* a, digit_t* c);        /////////////////// TEMPORARY
...
void fp2mul434_mont_old(const f2elm_t a, const f2elm_t b, f2elm_t c);     /////////////////// TEMPORARY
void fp2mul434_c0_mont(const digit_t* a, const digit_t* b, digit_t* c);     /////////////////// TEMPORARY
void fp2mul434_c0_asm(const digit_t* a, const digit_t* b, digit_t* c);        /////////////////// TEMPORARY
void fp2mul434_c1_mont(const digit_t* a, const digit_t* b, digit_t* c);     /////////////////// TEMPORARY
void fp2mul434_c1_asm(const digit_t* a, const digit_t* b, digit_t* c);        /////////////////// TEMPORARY
