...
void fp2sqr610_mont_old(const f2elm_t a, f2elm_t c);     /////////////////// TEMPORARY
void fp2sqr610_c0_mont(const digit_t* a, digit_t* c);     /////////////////// TEMPORARY
void fp2sqr610_c0_asm(const digit_t* a, digit_t* c);        /////////////////// TEMPORARY
void fp2sqr610_c1_mont(const digit_t* a, digit_t* c);     /////////////////// TEMPORARY
void fp2sqr610_c1_asm(const digit_t* a, digit_t* c);        /////////////////// TEMPORARY
...
void fp2mul610_mont_old(const f2elm_t a, const f2elm_t b, f2elm_t c);     /////////////////// TEMPORARY
void fp2mul610_c0_mont(const digit_t* a, const digit_t* b, digit_t* c);     /////////////////// TEMPORARY
void fp2mul610_c0_asm(const digit_t* a, const digit_t* b, digit_t* c);        /////////////////// TEMPORARY
void fp2mul610_c1_mont(const digit_t* a, const digit_t* b, digit_t* c);     /////////////////// TEMPORARY
void fp2mul610_c1_asm(const digit_t* a, const digit_t* b, digit_t* c);        /////////////////// TEMPORARY
