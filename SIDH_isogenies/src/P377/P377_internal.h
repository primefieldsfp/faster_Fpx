...
typedef digit_t felm_t[NWORDS_FIELD];                                 // Datatype for representing 377-bit field elements (448-bit max.)
typedef digit_t dfelm_t[2*NWORDS_FIELD];                              // Datatype for representing double-precision 2x377-bit field elements (2x448-bit max.) 
...
// 2x377-bit multiprecision subtraction followed by addition with p377*2^448, c = a-b+(p377*2^448) if a-b < 0, otherwise c=a-b 
...
void fp2sqr377_mont_old(const f2elm_t a, f2elm_t c);     /////////////////// TEMPORARY
void fp2sqr377_mont_old(const f2elm_t a, f2elm_t c);     /////////////////// TEMPORARY
void fp2sqr377_c0_mont(const digit_t* a, digit_t* c);     /////////////////// TEMPORARY
void fp2sqr377_c0_asm(const digit_t* a, digit_t* c);        /////////////////// TEMPORARY
void fp2sqr377_c1_mont(const digit_t* a, digit_t* c);     /////////////////// TEMPORARY
void fp2sqr377_c1_asm(const digit_t* a, digit_t* c);        /////////////////// TEMPORARY
...
void fp2mul377_mont_old(const f2elm_t a, const f2elm_t b, f2elm_t c);     /////////////////// TEMPORARY
void fp2mul377_mont_old(const f2elm_t a, const f2elm_t b, f2elm_t c);     /////////////////// TEMPORARY
void fp2mul377_c0_mont(const digit_t* a, const digit_t* b, digit_t* c);     /////////////////// TEMPORARY
void fp2mul377_c0_asm(const digit_t* a, const digit_t* b, digit_t* c);        /////////////////// TEMPORARY
void fp2mul377_c1_mont(const digit_t* a, const digit_t* b, digit_t* c);     /////////////////// TEMPORARY
void fp2mul377_c1_asm(const digit_t* a, const digit_t* b, digit_t* c);        /////////////////// TEMPORARY
