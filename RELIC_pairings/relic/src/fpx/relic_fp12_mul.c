...
#if 0
/////////////////////////////////////////////////////// Implementation with full new arithmetic for fp12_mul
////////////////////////////////////////////////////// NOT AS FAST AS VERSION WITH FULL ARITH FOR FP6MUL
void precomp12_381(dig_t* c, const dig_t* a) 
{ // Precomputes (b10+b11), (b10-b11), (b20+b21), (b20-b21) 
    precomp381_asm(&c[0*6], &a[2*6]);
    precomp381_asm(&c[2*6], &a[4*6]);
    precomp381_asm(&c[4*6], &a[6*6]);
    precomp381_asm(&c[6*6], &a[8*6]);
    precomp381_asm(&c[8*6], &a[10*6]);
}
...
void fp12_mul_lazyr(fp12_t c, fp12_t a, fp12_t b) {
	...
	RLC_TRY {
        ...
        precomp12_381((dig_t*)t[12], (dig_t*)b);  // Stores (b10+b11), (b10-b11), (b20+b21), (b20-b21)     
        fp12mul381c0_asm(t[0], a, b);
        fp12mul381c1_asm(t[0], a, b);
        fp12mul381c2_asm(t[0], a, b);
        fp12mul381c3_asm(t[0], a, b);
        fp12mul381c4_asm(t[0], a, b);
        fp12mul381c5_asm(t[0], a, b); 
